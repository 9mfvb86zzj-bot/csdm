...
const st = {
  ...
  setupCard: { background: C.panel, border: `1px solid ${C.border}`, borderRadius: 20, padding: '32px 28px', width: '100%', maxWidth: 460, boxShadow: '0 32px 80px rgba(0,0,0,0.5)', marginTop: 30 },
  playWrap: { width: '100%', maxWidth: 560, marginTop: 16 },
  logo: { display: 'block', fontSize: 34, fontWeight: 900, fontFamily: "'Georgia','Times New Roman',serif", color: '#fff', letterSpacing: 4, lineHeight: 1, textShadow: `0 0 40px ${C.blue}88` },
  logoSub: { display: 'block', fontSize: 10.5, letterSpacing: 3, color: C.bluePale, marginTop: 6, fontWeight: 600 },
  addRow: { display: 'flex', gap: 8, marginBottom: 14 },
  input: { width: '100%', background: 'rgba(255,255,255,0.06)', border: `1px solid ${C.border}`, borderRadius: 10, color: '#fff', padding: '12px 14px', fontSize: 14, outline: 'none', fontFamily: 'inherit', boxSizing: 'border-box' },
  addBtn: { background: C.blue, border: 'none', color: '#fff', borderRadius: 10, width: 46, fontSize: 20, fontWeight: 800, cursor: 'pointer', flexShrink: 0 },
  emptyBox: { background: 'rgba(255,255,255,0.04)', border: `1px solid ${C.border}`, borderRadius: 10, padding: 18, textAlign: 'center', color: C.muted, fontSize: 13.5, marginBottom: 14 },
  participantList: { display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 14, maxHeight: 220, overflowY: 'auto' },
  participantRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(255,255,255,0.04)', border: `1px solid ${C.border}`, borderRadius: 10, padding: '10px 14px', fontSize: 14 },
  removeBtn: { background: 'transparent', border: 'none', color: C.muted, cursor: 'pointer', fontSize: 14, padding: 4 },
  btnPrimary: { width: '100%', background: `linear-gradient(135deg,${C.blue},${C.blueHover})`, border: 'none', color: '#fff', borderRadius: 12, padding: 15, fontSize: 16, fontWeight: 800, letterSpacing: 1, cursor: 'pointer', fontFamily: 'inherit', marginTop: 6, boxShadow: `0 8px 24px ${C.blue}44` },
  btnSecondary: { width: '100%', background: 'transparent', border: `1px solid ${C.border}`, color: C.bluePale, borderRadius: 12, padding: 13, fontSize: 13.5, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', marginTop: 10 },
  backBtn: { background: 'transparent', border: `1px solid ${C.border}`, color: C.bluePale, borderRadius: 8, padding: '8px 14px', fontSize: 13, cursor: 'pointer', fontFamily: 'inherit', fontWeight: 600, flexShrink: 0 },
  topRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8, marginBottom: 16, flexWrap: 'wrap' },
  roundTag: { fontSize: 12, letterSpacing: 2, color: C.muted, fontWeight: 700 },
  consignaCard: { background: '#080808', border: `3px solid ${C.gold}55`, borderRadius: 18, padding: '32px 24px', textAlign: 'center', marginBottom: 14, boxShadow: '0 16px 48px rgba(0,0,0,0.6)', animation: 'alPop 0.35s ease' },
  consignaLabel: { fontSize: 11, letterSpacing: 4, color: C.gold, fontWeight: 800, marginBottom: 12 },
  consignaText: { fontSize: 20, fontWeight: 700, color: '#fff', lineHeight: 1.4 },
  ...
  participantBtn: { background: C.panel, border: `2px solid ${C.border}`, borderRadius: 14, padding: '16px 10px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', fontFamily: 'inherit', transition: 'all 0.15s' },
  participantBtnWin: { border: `2px solid ${C.gold}`, background: C.goldFaint, animation: 'alFlash 0.7s ease', transform: 'translateY(-2px)' },
  participantName: { fontSize: 14.5, fontWeight: 700, color: C.bright },
  participantScore: { fontSize: 11.5, color: C.muted, fontWeight: 600 },
  ...
  scoreboard: { background: 'rgba(0,0,0,0.3)', border: `1px solid ${C.border}`, borderRadius: 14, padding: 16 },
  sectionLabel: { fontSize: 11, letterSpacing: 3, color: C.muted, fontWeight: 700, marginBottom: 10 },
  scoreRow: { display: 'flex', alignItems: 'center', gap: 10, padding: '7px 0', borderBottom: '1px solid rgba(255,255,255,0.04)', fontSize: 14 },
  ...
  consignaRow: { display: 'flex', alignItems: 'center', gap: 8, background: 'rgba(255,255,255,0.04)', border: `1px solid ${C.border}`, borderRadius: 10, padding: '10px 12px' },
}
