...
const st = {
  ...
  btnSecondary: { width: '100%', background: C.scrim, border: `1px solid ${C.border}`, color: C.bright, borderRadius: C.radiusMd, padding: 13, fontSize: 13.5, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', marginTop: 10 },
  backBtn: { background: C.scrim, border: `1px solid ${C.border}`, color: C.bright, borderRadius: 8, padding: '8px 14px', fontSize: 13, cursor: 'pointer', fontFamily: 'inherit', fontWeight: 500, flexShrink: 0 },
  ...
  participantBtn: { background: C.panel, border: `1px solid ${C.border}`, borderRadius: 14, padding: '16px 10px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', fontFamily: 'inherit', backdropFilter: C.blurSm, WebkitBackdropFilter: C.blurSm, transition: 'all 0.15s' }, // not nested under another glass card — blur OK here
