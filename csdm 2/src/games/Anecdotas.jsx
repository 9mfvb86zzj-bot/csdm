...
const st = {
  ...
  btnSecondary: { width: '100%', background: C.panel, border: `1px solid ${C.border}`, color: C.bright, borderRadius: C.radiusMd, padding: 13, fontSize: 13.5, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', marginTop: 10, backdropFilter: C.blurSm, WebkitBackdropFilter: C.blurSm },
  backBtn: { background: C.panel, border: `1px solid ${C.border}`, color: C.bright, borderRadius: 8, padding: '8px 14px', fontSize: 13, cursor: 'pointer', fontFamily: 'inherit', fontWeight: 500, flexShrink: 0, backdropFilter: C.blurSm, WebkitBackdropFilter: C.blurSm },
