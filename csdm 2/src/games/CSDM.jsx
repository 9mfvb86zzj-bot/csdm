...
const s = {
  ...
  btnSecondary:{width:'100%',background:C.scrim,border:`1px solid ${C.border}`,color:C.bright,borderRadius:C.radiusMd,padding:13,fontSize:14,fontWeight:600,cursor:'pointer',fontFamily:'inherit',marginTop:8},
  ...
  backBtn:{background:C.scrim,border:`1px solid ${C.border}`,color:C.bright,borderRadius:8,padding:'8px 14px',fontSize:14,cursor:'pointer',fontFamily:'inherit',fontWeight:500,flexShrink:0},
  inviteBtn:{width:'100%',background:`${C.green}33`,border:`1px solid ${C.green}55`,color:'#fff',borderRadius:10,padding:'12px 16px',fontSize:14,fontWeight:600,cursor:'pointer',fontFamily:'inherit',marginBottom:18,letterSpacing:0.3},
